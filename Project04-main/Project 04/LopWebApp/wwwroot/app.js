...
// initial load
if (document.querySelector('#lopTable tbody')) { initLopModule(); }
if (document.querySelector('#svTable tbody')) { initSVModule(); }
if (document.querySelector('#dkTable tbody')) { initDKModule(); }
if (document.getElementById('runQ1')) { initQueryModule(); }
fetchStatus();

// --- DANG KY ---
function initDKModule() {
