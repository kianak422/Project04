...
namespace LopCRUDApp
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // ĐÂY LÀ DÒNG BẠN BỊ THIẾU, TÔI ĐÃ THÊM VÀO:
            SinhVienRepository svRepo = new SinhVienRepository(ConnectionString); 
            ...
            while (true)
            {
                ...
                // Sử dụng ?? "" để tránh lỗi null warning nếu muốn (tùy chọn)
                ...
                switch (choice)
                {
                    ...
                    case "9": GetKhoaForSinhVien(queryRepo); break;
                    case "10": GetDiemForAllMonHoc(queryRepo); break;
                    case "11": queryRepo.GetDiemTrungBinhCaoNhatKhoa(); break;
        ...
        static void GetSinhVienByMaSVAndSite(SinhVienRepository repo)
        {
            ...
            Console.WriteLine("\n--- Thông tin Sinh Viên ---");
            Console.WriteLine(
                $"MaSV: {sv.MaSV}, HoTen: {sv.HoTen}, Phai: {sv.Phai}, " + $"NgaySinh: {sv.NgaySinh:yyyy-MM-dd}, MaLop: {sv.MaLop}, HocBong: {sv.HocBong}, Site: {sv.Site}");
        }
